...
export const initialState = {"reflex___state____state": {"is_hydrated_rx_state_": false, "router_rx_state_": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "cookie": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": "", "raw_headers": {}}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}, "url": "", "route_id": ""}}, "reflex___state____state.ck_shelf___backend___state____state": {"users_rx_state_": [{"name": "Danilo Sousa", "email": "danilo@example.com", "gender": "Male"}, {"name": "Zahra Ambessa", "email": "zahra@example.com", "gender": "Female"}], "users_for_graph_rx_state_": []}, "reflex___state____state.reflex___state____frontend_event_exception_state": {}, "reflex___state____state.reflex___state____on_load_internal_state": {}, "reflex___state____state.reflex___state____update_vars_internal_state": {}}

export const defaultColorMode = "system"
export const ColorModeContext = createContext(null);
export const UploadFilesContext = createContext(null);
export const DispatchContext = createContext(null);
export const StateContexts = {reflex___state____state: createContext(null),reflex___state____state__ck_shelf___backend___state____state: createContext(null),reflex___state____state__reflex___state____frontend_event_exception_state: createContext(null),reflex___state____state__reflex___state____on_load_internal_state: createContext(null),reflex___state____state__reflex___state____update_vars_internal_state: createContext(null),};
...
const [reflex___state____state__ck_shelf___backend___state____state, dispatch_reflex___state____state__ck_shelf___backend___state____state] = useReducer(applyDelta, initialState["reflex___state____state.ck_shelf___backend___state____state"])
...
"reflex___state____state.ck_shelf___backend___state____state": dispatch_reflex___state____state__ck_shelf___backend___state____state,
...
createElement(StateContexts.reflex___state____state__ck_shelf___backend___state____state,{value: reflex___state____state__ck_shelf___backend___state____state},
